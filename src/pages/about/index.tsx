    ...
    <Default>
      <div className="flex flex-col gap-14">
        <div className='block md:flex gap-10'>
          ...
          <div className='text-zinc-700 text-xl flex flex-col gap-6'>
        ...
        <div className="block md:flex gap-10">
          ...
          <img className='max-w-lg object-cover' src="https://media.istockphoto.com/id/483396505/photo/unpleasant-meeting.jpg?s=612x612&w=0&k=20&c=1qzUEvNrGgQF2xeTvN1WTf_9yUekA1S5t1YdwxN3uRY=" />
        </div>
      </div>
    </Default>
  )
